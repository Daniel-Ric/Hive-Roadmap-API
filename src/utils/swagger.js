...
const options = {
    definition: {
        ...
        info: {
            ...
            version: "1.1.0",
            description:
                "High-level REST API over The Hive roadmap (Featurebase) with aggregation, structured responses and webhook dispatch.\n\n"},
        servers: [
            {
                url: serverUrl,
        ...
        tags: [
            {
                name: "Health",
                description: "Service readiness, liveness and basic diagnostics."
            },
            {
                name: "Roadmap Meta",
            ...
            {
                name: "Roadmap Status",
                description: "Operations for working with individual roadmap statuses."
            },
            {
                name: "Roadmap Aggregation",
                description: "High-level aggregated snapshots across multiple statuses."
            },
            {
                name: "Roadmap Items",
                description: "Access to individual roadmap items and public URLs."
            },
            {
                name: "Webhooks",
                description: "Webhook registration, inspection and testing for roadmap events."
            }
        ],
        components: {
            schemas: {
                ...
                OrganizationSummary: {
                    ...
                    properties: {
                        organization: {
                            ...
                            properties: {
                                id: {type: "string"},
                                slug: {type: "string", description: "Internal organization slug, for example hivegameslimited"},
                ...
                RoadmapConfig: {
                    ...
                    properties: {
                        ...
                        statuses: {
                            type: "array",
                            items: {$ref: "#/components/schemas/RoadmapStatus"}
                        },
                        roadmaps: {
                            type: "array",
                            items: {
                ...
                RoadmapItemStats: {
                    ...
                    properties: {
                        ...
                        mergedSubmissions: {type: "integer"}
                    }
                },
                ...
                RoadmapItemUrls: {
                    ...
                    properties: {
                        ...
                        api: {
                            type: "string",
                            description: "Internal API URL used by this service or upstream"
                        }
                    }
                },
                RoadmapItem: {
                    ...
                    properties: {
                        ...
                        tags: {
                            type: "array",
                            items: {$ref: "#/components/schemas/RoadmapItemTag"}
                        },
                        ...
                        raw: {
                            type: "object",
                            additionalProperties: true,
                            description: "Full upstream submission payload"
                        }
                    },
                ...
                AggregateSnapshot: {
                    ...
                    properties: {
                        ...
                        statuses: {
                            type: "array",
                            items: {$ref: "#/components/schemas/AggregateStatusBlock"}
                        },
                        generatedAt: {type: "string", format: "date-time"}
                    },
                ...
                WebhookCreateRequest: {
                    ...
                    properties: {
                        ...
                        active: {
                            type: "boolean",
                            description: "Whether the webhook is active immediately after creation"
                        }
                    },
                    example: {
        ...
        paths: {
            ...
            "/roadmap/organization": {
                get: {
                    ...
                    description:
                        "Fetches the upstream organization document from Featurebase and extracts key roadmap-related fields.\n\n" +
                        "Use this endpoint when you want a view that is close to the source data for debugging or exploration.",
                    responses: {
                        200: {
                            description: "Organization payload with roadmap configuration",
                            content: {
                                "application/json": {
            ...
            "/roadmap/meta": {
                get: {
                    ...
                    description:
                        "Returns a normalized snapshot of the Hive roadmap configuration including:\n" +
                        "- Organization summary\n" +
                        "- Full list of postStatuses\n" +
                        "- Roadmap definitions (columns and filters)",
                    responses: {
                        200: {
                            description: "Roadmap metadata snapshot",
                            content: {
                                "application/json": {
                        ...
                        500: {
                            description: "Failed to build roadmap metadata snapshot",
                            content: {
                                "application/json": {
                                    schema: {$ref: "#/components/schemas/ErrorResponse"}
                                }
            ...
            "/roadmap/statuses": {
                get: {
                    ...
                    description:
                        "Returns all roadmap post statuses, including canonical IDs for the Featurebase submission API, color and type.\n\n" +
                        "These IDs can be used directly with `GET /roadmap/status/{statusId}/items`.",
                    responses: {
                        200: {
                            description: "List of roadmap statuses",
                            content: {
                                "application/json": {
                        ...
                        500: {
                            description: "Failed to fetch roadmap statuses",
                            content: {
                                "application/json": {
                                    schema: {$ref: "#/components/schemas/ErrorResponse"}
                                }
            ...
            "/roadmap/status/{statusId}/items": {
                get: {
                    ...
                    description:
                        "Aggregates all pages for a given roadmap status and returns a normalized snapshot of all items.\n\n" +
                        "Pagination is handled internally using the upstream `page` parameter. The response includes per-category totals and rich item metadata, " +
                        "suitable for dashboards, bots or analytics.\n\n" +
                    ...
                    responses: {
                        200: {
                            description: "Status snapshot including items and totals",
                            content: {
                                "application/json": {
                        ...
                        500: {
                            description: "Failed to fetch or aggregate items for the given status",
                            content: {
                                "application/json": {
                                    schema: {$ref: "#/components/schemas/ErrorResponse"}
                                }
            ...
            "/roadmap/aggregate": {
                get: {
                    ...
                    description:
                        "Aggregates all roadmap statuses into a single snapshot.\n\n" +
                    ...
                    responses: {
                        200: {
                            description: "Aggregate snapshot of all statuses",
                            content: {
                                "application/json": {
                        ...
                        429: {
                            description: "Too many aggregate requests in the configured time window",
                            content: {
                                "application/json": {
                                    schema: {$ref: "#/components/schemas/ErrorResponse"}
                                }
                        ...
                        500: {
                            description: "Failed to build aggregate snapshot",
                            content: {
                                "application/json": {
                                    schema: {$ref: "#/components/schemas/ErrorResponse"}
                                }
            ...
            "/roadmap/item/{id}": {
                get: {
                    ...
                    description:
                        "Fetches a single roadmap item from the upstream API using its internal id and returns a normalized view.\n\n" +
                    ...
                    responses: {
                        200: {
                            description: "Single roadmap item",
                            content: {
                                "application/json": {
                        ...
                        500: {
                            description: "Failed to fetch or normalize item",
                            content: {
                                "application/json": {
                                    schema: {$ref: "#/components/schemas/ErrorResponse"}
                                }
            ...
            "/roadmap/item/by-slug/{slug}": {
                get: {
                    ...
                    description:
                        "Resolves the public updates.playhive.com URL for a given card slug.\n\n" +
                    ...
                    responses: {
                        200: {
                            ...
                            content: {
                                "application/json": {
                                    schema: {$ref: "#/components/schemas/PublicSlugResolution"},
                                    example: {
            ...
            "/webhooks": {
                get: {
                    ...
                    description:
                        "Returns all registered webhooks in the current process.\n\n" +
                ...
                post: {
                    ...
                    description:
                        "Registers a new webhook for roadmap events.\n\n" +
                    ...
                    responses: {
                        ...
                        400: {
                            description: "Validation error when creating webhook",
                            content: {
                                "application/json": {
                                    schema: {$ref: "#/components/schemas/ErrorResponse"}
                                }
                        ...
                        429: {
                            description: "Webhook creation rate limit exceeded",
                            content: {
                                "application/json": {
                                    schema: {$ref: "#/components/schemas/ErrorResponse"}
                                }
            ...
            "/webhooks/{id}": {
                ...
                delete: {
                    ...
                    description:
                        "Deletes a webhook by id. Subsequent events will no longer be delivered to this URL from this API instance.",
                    parameters: [
                        {
                            in: "path",
                            name: "id",
                    ...
                    responses: {
                        ...
                        429: {
                            description: "Webhook deletion rate limit exceeded",
                            content: {
                                "application/json": {
                                    schema: {$ref: "#/components/schemas/ErrorResponse"}
                                }
            ...
            "/webhooks/{id}/test": {
                post: {
                    ...
                    description:
                        "Sends a `webhook.test` event to the registered webhook URL.\n\n" +
                    ...
                    responses: {
                        ...
                        429: {
                            description: "Test webhook rate limit exceeded",
                            content: {
                                "application/json": {
                                    schema: {$ref: "#/components/schemas/ErrorResponse"}
                                }
